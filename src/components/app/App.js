    ...
    return (
        <Container>
            <div className="slider w-50 m-auto">
                ...
                <div className="text-center mt-5">Active slide {slide} <br />{autoplay.autoplay !== false ? 'auto' : null} {autoplay.autoplay === 300 ? ' slow' : null} {autoplay.autoplay === 700 ? ' fast' : null} {autoplay.autoplay === 5000 ? ' custom' : null}</div>
                <div className="buttons mt-3">
                    ...
                    <button
                        className="btn btn-primary me-2"
                        onClick={(e) => dispatch({ type: 'custom', payload: +e.target.textContent })} > 5000</button>
                </div >
            </div >
        </Container >
    )
